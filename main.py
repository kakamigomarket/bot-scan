...
THRESHOLD_RETAIL = float(os.getenv("THRESHOLD_RETAIL", "3.2"))
...
MODE_PROFILES = {
    "retail": {"ADX_MIN":20.0,"ATR_PCT_MIN_BREAKOUT":0.08,"AVG_TRADES_MIN":80,"REQUIRE_2_TF":False,"THRESH":THRESHOLD_RETAIL},
